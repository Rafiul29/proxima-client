...
const ProjectDetails = ({ project }) => {
  return (
    <div className="project bg-slate-500 p-5 rounded-xl shadow-xl border border-slate-700 flex flex-col gap-5 w-[30rem]">
      <div className="top">
      ...
      <div className="mid text-slate-300 flex gap-10">
        ...
        <div className="right flex flex-col ">
            ...
            <span>Duration: {`${project.duration} week${project.duration==1 ? "" : "s"}`}</span>
        </div>
      </div>
